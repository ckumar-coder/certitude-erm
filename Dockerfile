...
COPY --chown=app:app server.js auth.js db.js csv.js email.js validate.js fileScan.js gcs.js seed-controls-data.js activate-test-user.js disable-mfa-test-user.js ./
